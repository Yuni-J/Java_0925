...
public class Class01 {
	...
	public static void main(String[] args) {
		 ...
		 * - 맴버변수와, 메서드는 public 상관없음.
		 * - 일반적으로 각 클래스의 맴버변수는 private이 원칙 / method는 pubilc이 일반적
		 * - private은 내 클래스에서만 사용가능. (다른 클래스에서는 접근 불가능)
		 * - private으로 선언된 맴버변수에 접근하기 위해서는 getter/setter가 필요
		 * 
		 * - 접근제한자
		 * private : 나 (내 클래스)
		 * (default) : 나 + 패키지
...
class Test1{
	...
	// getter : 맴버변수의 값을 리턴하는 메서드
	public int getA() {
		return this.a;  //this 맴버변수를 의미하는 키워드
	}
	public int getB() {
		 return this.b;
	}
